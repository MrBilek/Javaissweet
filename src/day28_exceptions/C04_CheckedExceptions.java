...
public class C04_CheckedExceptions {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        IA(Input/Output) islemlerinde Java ya okuyamazsam, ya yazamazsam diyerek
        ...
        beklenilen excetionlar i deklare edebiliriz.
        Bu sadece olayin farkinda oldugumuzu deklare eder.
        exception firlatmanin ve kodu durdurmanin onune gecmez.

        kod calismaya devam etsin: try-catch-(finally) blogu kullaniriz.
         */
