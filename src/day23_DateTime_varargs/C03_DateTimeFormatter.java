...
public class C03_DateTimeFormatter {
    public static void main(String[] args) {
        ...
        System.out.println(ldt); // 2022-12-20T12:37:49.21041120
        ...
        // Sadece tarihi 12.20.2022 Tue SEKLİNDE yazdirin

        DateTimeFormatter format2= DateTimeFormatter.ofPattern("MM.dd.YY EEE"); //12.20.22 Sal

        System.out.println(ldt.format(format2));

        // Sadece zamani 12.51 ös olarak yazdirin
