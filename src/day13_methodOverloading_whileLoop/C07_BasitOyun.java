...
public class C07_BasitOyun {
    public static void main(String[] args) {
        ...
        tutttugumuz sayi ile karsilastirip tahmini buyult/kucult
        kullanici tuttugumuz sayiyi bildiginde
        tahmin sayisini ve

       3 veya daha az tahminde bildiyse "Vaoww"
       -4-8 tahminde bildiye "Aferin"
       - daha fazla tahminde bildiyse "basarisiz" yazdiralim
         */
